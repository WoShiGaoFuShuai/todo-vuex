<template>
  <div @click="cancelDeleteDoneTasks" class="modal-confirm-del wrapper">
    <div class="confirm" @click.stop="">
      <form @submit.prevent="" class="form">
        <div class="top-wrapper">
          <div class="btn-wrapper">
            <button
              @click="cancelDeleteDoneTasks"
              type="button"
              class="btn"
            ></button>
          </div>
        ...
        <div class="button-wrapper-btm">
          <button @click="cancelDeleteDoneTasks" type="button" class="cancel">
            Cancel
          </button>
          <button @click="confirmDeleteDoneTasks" type="button" class="remove">
            Remove
          </button>
        </div>
      </form>
...
<script>
export default {
  name: "ConfirmDeleteDoneTask",
  data() {
    return {};
  },
  methods: {
    cancelDeleteDoneTasks() {
